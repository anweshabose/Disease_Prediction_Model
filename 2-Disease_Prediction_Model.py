...
# Command: "streamlit run 2-Disease_Prediction_Model.py" to run this file.
...
# Extract and view all Diseases that are available
...
if len(selected_symptoms) < 6:
    ...
    # Set value "1" for selected symptoms and "0" for those symptoms that are not selected
